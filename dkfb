...
def siapa():
	os.system('clear')
	nama = raw_input("\033[1;97mSiapa lo ? \033[1;91m: \033[1;92m")
	if nama =="":
		print"\033[1;96m[!] \033[1;91mIsi yang bener"
		time.sleep(1)
		siapa()
	else:
		os.system('clear')
		jalan("\033[1;97mwelcome \033[1;92m" +nama+ "\n\033[1;97mgak usah banyak bacot langsung saja !!")
		time.sleep(1)
		loginSC()
...
def loginSC():
	os.system('clear')
	print"\033[1;97mlogin SC nya dulu njeng\n"
	username = raw_input("\033[1;96m[*] \033[1;97mUsername \033[1;91m: \033[1;92m")
	password = raw_input("\033[1;96m[*] \033[1;97mPassword \033[1;91m: \033[1;92m")
	if username =="kemet" and password =="chanel":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/kemetchanel')
				menu()
